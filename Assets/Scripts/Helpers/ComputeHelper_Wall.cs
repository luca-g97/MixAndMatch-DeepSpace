...
namespace Seb.Helpers
{
	...
	public static class ComputeHelper_Wall
	{
		...
		{
			cs.Dispatch(kernelIndex, numIterations.x, numIterations.y, numIterations.z);
		}
		...
		{
			Vector3Int threadGroupSizes = GetThreadGroupSizes(cs, kernelIndex);
			cs.Dispatch(kernelIndex, texture.width, texture.height, texture.volumeDepth);
		}

		public static void Dispatch(ComputeShader cs, Texture2D texture, int kernelIndex = 0)
		{
			Vector3Int threadGroupSizes = GetThreadGroupSizes(cs, kernelIndex);
			cs.Dispatch(kernelIndex, texture.width, texture.height, 1);
		}
		...
		public static RenderTexture CreateRenderTexture(int width, int height, FilterMode filterMode, GraphicsFormat format, string name = "Unnamed", DepthMode_Wall depthMode = DepthMode_Wall.None, bool useMipMaps = false)
		{
		...
		public static bool CreateRenderTexture(ref RenderTexture texture, int width, int height, FilterMode filterMode, GraphicsFormat format, string name = "Unnamed", DepthMode_Wall depthMode = DepthMode_Wall.None, bool useMipMaps = false)
		{
