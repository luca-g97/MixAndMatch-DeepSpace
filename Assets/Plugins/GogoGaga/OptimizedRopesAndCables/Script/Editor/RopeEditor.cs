...
namespace GogoGaga.OptimizedRopesAndCables
{
    ...
    public class RopeEditor : Editor
    {
        ...
        private SerializedProperty gravityDirection;
        ...
        private void OnEnable()
        {
            ...
            gravityDirection = serializedObject.FindProperty(nameof(Rope.gravityDirection));
            groundLevel = serializedObject.FindProperty(nameof(Rope.groundLevel));
        ...
        private void RopeTransforms()
        {
            ...
            EditorGUILayout.Space(2);
            EditorGUILayout.PropertyField(gravityDirection, new GUIContent("Gravity Direction", "Direction of the gravity affecting the rope, default is down"));
            EditorGUILayout.Space(2);
            EditorGUILayout.PropertyField(groundLevel, new GUIContent("Ground Level", "The level at which the rope will be considered to be touching the ground, default is 0"));
